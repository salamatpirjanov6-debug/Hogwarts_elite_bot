...
BOOKS_ALL = [{"name": "📚 All Books (1-8)", "file_id": "BQACAgIAAxkBAAIDR2nOlaH2TdI0xcdn3sg8xJkeqLBIAAI0HwACIynpS2_wVwpElnx4OgQ", "caption": "📚 Harry Potter All Books\n\nChannel: @harry_potter_fans_uz"}]

# --- MA'LUMOTLAR BAZASI (KINOLAR) ---
MOVIES_UZ = [
    {"name": "🎬 1. Hikmatlar toshi", "file_id": "BAACAgIAAxkBAAN0acuyGAMCrWD9TTuMq55gFHUM8scAAr2OAAKIIOhKA6wazQylWz46BA", "caption": "1. 🎬 HP 1: Hikmatlar toshi\n\nKanal: @harry_potter_fans_uz"},
    {"name": "🎬 2. Maxfiy hujra", "file_id": "BAACAgIAAxkBAAOFacu0BPXsr3WF3yYGmJHdjVeDjSMAAmSFAALhnOhKpL77RQyPlaE6BA", "caption": "2. 🎬 HP 2: Maxfiy hujra\n\nKanal: @harry_potter_fans_uz"},
    {"name": "🎬 3. Azkoban maxbusi", "file_id": "BAACAgIAAxkBAAOHacu0W-SHgaTmaKyMu7N7S4D-9NQAAn6FAALhnOhKpYQqLyzBd-k6BA", "caption": "3. 🎬 HP 3: Azkoban maxbusi\n\nKanal: @harry_potter_fans_uz"},
    {"name": "🎬 4. Alanga kubogi", "file_id": "BAACAgIAAxkBAAOJacu1AoUKWQUInEPM0DGXvSZhueUAAqmFAALhnOhKZfF9wiu0Drs6BA", "caption": "4. 🎬 HP 4: Alanga kubogi\n\nKanal: @harry_potter_fans_uz"},
    {"name": "🎬 5. Feniks jamiyati", "file_id": "BAACAgIAAxkBAAOHacu0W-SHgaTmaKyMu7N7S4D-9NQAAn6FAALhnOhKpYQqLyzBd-k6BA", "caption": "5. 🎬 HP 5: Feniks jamiyati\n\nKanal: @harry_potter_fans_uz"},
    {"name": "🎬 6. Tilsim Shahzoda", "file_id": "BAACAgIAAxkBAAONacu1kktAejSVYq9GM3xmHXGzrfAAAoyFAALhnOhKrgZBW8bL1Ws6BA", "caption": "6. 🎬 HP 6: Tilsim Shahzoda\n\nKanal: @harry_potter_fans_uz"},
    {"name": "🎬 7. Ajal tuhfasi 1", "file_id": "BAACAgIAAxkBAAOPacu1qaZL-FLQaWMNmAbS1P6B-DUAApeFAALhnOhKF_fANiYvpAk6BA", "caption": "7. 🎬 HP 7: Ajal tuhfasi 1-qism\n\nKanal: @harry_potter_fans_uz"},
    {"name": "🎬 8. Ajal tuhfalari 2", "file_id": "BAACAgIAAxkBAAOJacu1AoUKWQUInEPM0DGXvSZhueUAAqmFAALhnOhKZfF9wiu0Drs6BA", "caption": "8. 🎬 HP 8: Ajal tuhfalari 2-qism\n\nKanal: @harry_potter_fans_uz"},
]

MOVIES_RU = [
    {"name": "🎬 1. Философский камень", "file_id": "BAACAgIAAxkBAAIDSWnOlb1_AAGAYgWnEGm3bGJfXjFeggACKAoAAjH_WUs4J1skcGE7GToE", "caption": "1. 🎬 ГП 1: Философский камень\n\n@harry_potter_fans_uz"},
    {"name": "🎬 2. Тайная комната", "file_id": "BAACAgIAAxkBAAIDS2nOld1zIwQEOIo_XNaB20dS4yBKAAImCgACMf9ZS8YV5UtV-2QLOgQ", "caption": "2. 🎬 ГП 2: Тайная комната\n\n@harry_potter_fans_uz"},
    {"name": "🎬 3. Узник Азкабана", "file_id": "BAACAgIAAxkBAAIDTWnOlfGGh3F6yuTdkzg6YDll0LciAAInCgACMf9ZSxH4i6-D8wN7OgQ", "caption": "3. 🎬 ГП 3: Узник Азкабана\n\n@harry_potter_fans_uz"},
    {"name": "🎬 4. Кубок огня", "file_id": "BAACAgIAAxkBAAIDT2nOlgJFMBSJSqBULhYTkSS0dmsdAAIjCgACMf9ZS1Zt8gABJXZpWDoE", "caption": "4. 🎬 ГП 4: Кубок огня\n\n@harry_potter_fans_uz"},
    {"name": "🎬 5. Орден Феникса", "file_id": "BAACAgQAAxkBAAIDUWnOlhMJxYJ_yWbXZLJ25ZPTS0JJAAKgDAAC2L_JULzvFz_NQdPnOgQ", "caption": "5. 🎬 ГП 5: Орден Феникса\n\n@harry_potter_fans_uz"},
    {"name": "🎬 6. Принц-полукровка", "file_id": "BAACAgIAAxkBAAIDU2nOliUy9hL1ssJ5e-kORyqEL5DgAAIlCgACMf9ZS2Yi3TnE3abiOgQ", "caption": "6. 🎬 ГП 6: Принц-полукровка\n\n@harry_potter_fans_uz"},
    {"name": "🎬 7. Дары Смерти 1", "file_id": "BAACAgIAAxkBAAIDVWnOljREOEjf4v0o0Sz2DHs1Zm3xAALpBAACKP2pSAiPJCewUqfUOgQ", "caption": "7. 🎬 ГП 7: Дары Смерти: Часть 1\n\n@harry_potter_fans_uz"},
    {"name": "🎬 8. Дары Смерти 2", "file_id": "BAACAgIAAxkBAAIDV2nOlkSVUkDW2WL6f4WrUmapIQABcQACZQQAAsSsoUjP9fxCTDgDNzoE", "caption": "8. 🎬 ГП 8: Дары Смерти: Часть 2\n\n@harry_potter_fans_uz"},
]

MOVIES_EN = [
    {"name": "🎬 1. Sorcerer's Stone", "file_id": "BAACAgQAAxkBAAIDWWnOltDBBkgHlm6EC5zZ1__vemdSAAJ_BwACrMaBUKRYUpDTm11oOgQ", "caption": "1. 🎬 HP 1: Sorcerer's Stone\n\n@harry_potter_fans_uz"},
    {"name": "🎬 2. Chamber of Secrets", "file_id": "BAACAgQAAxkBAAIDW2nOlynvMgKOoF9hn7r8CcccUZo-AAKBBwACrMaBUM7959H4o01HOgQ", "caption": "2. 🎬 HP 2: Chamber of Secrets\n\n@harry_potter_fans_uz"},
    {"name": "🎬 3. Prisoner of Azkaban", "file_id": "BAACAgQAAxkBAAIDXWnOlz4dtzVGjgW6u9JUz1frSKKNAAKHBwACrMaBUKP9MbVImI-uOgQ", "caption": "3. 🎬 HP 3: Prisoner of Azkaban\n\n@harry_potter_fans_uz"},
    {"name": "🎬 4. Goblet of Fire", "file_id": "BAACAgQAAxkBAAIDX2nOl0-8b1wOF8VhdnLiVTmx2lQ0AAKOBwACrMaBUNmv6Ega62iuOgQ", "caption": "4. 🎬 HP 4: Goblet of Fire\n\n@harry_potter_fans_uz"},
    {"name": "🎬 5. Order of the Phoenix", "file_id": "BAACAgQAAxkBAAIDYWnOl1-UJIPeUi9iwkH5xveOb1cBAAKVBwACrMaBUC7iNQH-PQokOgQ", "caption": "5. 🎬 HP 5: Order of the Phoenix\n\n@harry_potter_fans_uz"},
    {"name": "🎬 6. Half-Blood Prince", "file_id": "BAACAgQAAxkBAAIDY2nOl28ipXgwucm7uiCsJ00NrHObAAKNCAACqwKBUHgSmGHyOYgROgQ", "caption": "6. 🎬 HP 6: Half-Blood Prince\n\n@harry_potter_fans_uz"},
    {"name": "🎬 7. Deathly Hallows 1", "file_id": "BAACAgQAAxkBAAIDZWnOl36nQLjV7TlugAMlJE6y1xFKAAKXCAACqwKBUMiAIxlbsJmOOgQ", "caption": "7. 🎬 HP 7: Deathly Hallows Part 1\n\n@harry_potter_fans_uz"},
    {"name": "🎬 8. Deathly Hallows 2", "file_id": "BAACAgQAAxkBAAIDZ2nOl41aUWcgKRzzP_r-suInRRSKAAKkCAACqwKBUC733-s2FjB3OgQ", "caption": "8. 🎬 HP 8: Deathly Hallows Part 2\n\n@harry_potter_fans_uz"},
]

# --- SHLYAPA (SIZ AYTGAN MAXSUS MATNLAR) ---
HOUSES_DETAILS = {
    "Hufflepuff": {
        "emoji": "🦡", "kalit": "aql", 
        "txt": "💭 E-eh, men ko'ryapman... \nSadoqat senda birinchi o'rinda. Mehnat qilishdan qo'rqmaysan, do'stlaring uchun joningni berishga tayyorsan."
    },
    "Gryffindor": {
        "emoji": "🦁", "kalit": "jasorat", 
        "txt": "🦁 Yuraging to'la qo'rqmaslik. Sen xavf-xatarga tik boqishni bilasan. Jasurlik sening qoningda!"
    },
    "Slytherin": {
        "emoji": "🐍", "kalit": "ilon", 
        "txt": "🐍 Buyuklikka intilish... Makr va aqlli munosabat. Sen maqsad sari hech narsadan to'xtamaysan!"
    },
    "Ravenclaw": {
        "emoji": "🦅", "kalit": "burgut", 
        "txt": "🦅 O'tkir zehn va bilimga chanqoqlik. Sening aqling har qanday jumboqni yecha oladi!"
    }
}
...
async def mute_user(message: types.Message):
    if message.chat.type == 'private' or not (await message.chat.get_member(message.from_user.id)).is_chat_admin(): return
    ...
    try:
        ...
        msg = await message.answer(f"🙊 {target.first_name} <b>{mute_time}</b> daqiqaga mute qilindi.", parse_mode="HTML")
...
async def unmute_user(message: types.Message):
    ...
    try:
        ...
        msg = await message.answer(f"🔊 {target.first_name} mutedan olindi.", parse_mode="HTML")
        asyncio.create_task(delete_after_delay(msg))
    except: pass
...
async def start_cmd(message: types.Message):
    ...
    if not in_ch or not in_gr:
        ...
        return await message.answer(f"Salom {message.from_user.first_name}! Botdan foydalanish uchun obuna bo'ling:", reply_markup=btn, parse_mode="HTML")
    await message.answer(f"Xush kelibsiz {message.from_user.first_name}! ✨", reply_markup=main_menu(), parse_mode="HTML")
...
async def callback_handler(callback: types.CallbackQuery):
    uid, data = callback.message.chat.id, callback.data
    if data == "back_to_main":
        ...
        _, l, idx = data.split("_")
        item = (BOOKS_UZ if l == "uz" else BOOKS_EN)[int(idx)]
        ...
        await bot.send_video(uid, src[int(idx)]["file_id"], caption=src[int(idx)]["caption"])
    await callback.answer()

# --- SHLYAPA (SIZ AYTGAN TO'LIQ LOGIKA) ---
...
async def sorting_hat(message: types.Message):
    ...
    final_text = (
        f"{h['txt']}\n\n"
        f"✨ *Hamma narsa ayon!* ✨\n\n"
        f"Sizning fakultetingiz: {h['emoji']} <b>{h_name}</b> {h['emoji']}\n"
        f"🔑 Kalit so'zi: <code>{h['kalit']}</code>\n\n"
...
async def save_welcome_final(message: types.Message):
    ...
    data[str(message.chat.id)] = {"text": message.caption or message.text or "Xush kelibsiz!", "file_id": f_id, "file_type": f_type}
